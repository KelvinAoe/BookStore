...
const BookSingleCard = ({book}) => {
  ...
  return (
    <div
          key={book._id}
          className="relative px-4 py-2 m-4 border-2 border-gray-500 rounded-xl hover:shadow-xl"
        >
          <h2 className="absolute px-4 bg-red-300 rounded-lg top-1 right-2">
            {book.publishYear}
          </h2>
          ...
          <div className="flex items-center justify-between p-4 mt-4 gap-x-2">
            <BiShow className="text-3xl text-blue-800 cursor-pointer hover:text-black" onClick={()=>setShowModal(true)}/>
